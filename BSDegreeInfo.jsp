...
<body>
    <table border="1">
        <tr>
            ...
            <form action="BSDegreeInfo.jsp" method="get">
                <select name="SSN">

            <%

                Statement statement1 = conn.createStatement();
                ResultSet rs1 = statement1.executeQuery("Select ssn from student where enrolled = 'YES' and isgraduate = 'NO'");
            ...
            <%
                ...
                ResultSet rs2 = statement2.executeQuery("Select name from degree");
            ...
            <%
                    ...
                    String degree_name = request.getParameter("degree_name"); //只有一个学位
                    while (rs.next()) {
        
            %>

                    <tr>
                        <form action="BSDegreeReport.jsp" method="get">
                            ...
                            <th><input value="<%= degree_name  %>" name="degree_name" size="10" readonly></th>
